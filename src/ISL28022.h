...
#define BUS_VOLTAGE_RANGE_64V(x)          (x |=  (BUS_VOLTAGE_RANGE_64_VAL << POS_BUS_VOLTAGE_RANGE_BIT))
...
#define BUS_ADC_CFG_12b(x)                (x |=  (ADD_CONFIGURATION_REG_13b_VAL << POS_BUS_ADC_RESOLUTION_BIT))   
#define BUS_ADC_CFG_13b(x)                (x |=  (ADD_CONFIGURATION_REG_13b_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_14b(x)                (x |=  (ADD_CONFIGURATION_REG_14b_VAL << POS_BUS_ADC_RESOLUTION_BIT))          
#define BUS_ADC_CFG_15b(x)                (x |=  (ADD_CONFIGURATION_REG_15b_VAL << POS_BUS_ADC_RESOLUTION_BIT))        
#define BUS_ADC_CFG_15b_AV1(x)            (x |=  (ADD_CONFIGURATION_REG_15b_AV1_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV2(x)            (x |=  (ADD_CONFIGURATION_REG_15b_AV2_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV4(x)            (x |=  (ADD_CONFIGURATION_REG_15b_AV4_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV8(x)            (x |=  (ADD_CONFIGURATION_REG_15b_AV8_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV16(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV16_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV32(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV32_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV64(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV64_VAL << POS_BUS_ADC_RESOLUTION_BIT))  
#define BUS_ADC_CFG_12b_AV128(x)          (x |=  (ADD_CONFIGURATION_REG_15b_AV128_VAL << POS_BUS_ADC_RESOLUTION_BIT))  

/* always reset before to set */
#define RESET_SHUNT_ADC_SETTING(x)         (x &= ~(MASK_4_BITS << POS_SHUNT_RESOLUTION_BIT))
#define SHUNT_ADC_CFG_12b(x)               (x |=  (ADD_CONFIGURATION_REG_13b_VAL << POS_SHUNT_RESOLUTION_BIT))     
#define SHUNT_ADC_CFG_13b(x)               (x |=  (ADD_CONFIGURATION_REG_13b_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_14b(x)               (x |=  (ADD_CONFIGURATION_REG_14b_VAL << POS_SHUNT_RESOLUTION_BIT))          
#define SHUNT_ADC_CFG_15b(x)               (x |=  (ADD_CONFIGURATION_REG_15b_VAL << POS_SHUNT_RESOLUTION_BIT))        
#define SHUNT_ADC_CFG_15b_AV1(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV1_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV2(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV2_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV4(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV4_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV8(x)           (x |=  (ADD_CONFIGURATION_REG_15b_AV8_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV16(x)          (x |=  (ADD_CONFIGURATION_REG_15b_AV16_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV32(x)          (x |=  (ADD_CONFIGURATION_REG_15b_AV32_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV64(x)          (x |=  (ADD_CONFIGURATION_REG_15b_AV64_VAL << POS_SHUNT_RESOLUTION_BIT))  
#define SHUNT_ADC_CFG_12b_AV128(x)         (x |=  (ADD_CONFIGURATION_REG_15b_AV128_VAL << POS_SHUNT_RESOLUTION_BIT))
